...
Workbooks.Open "c:\thanachart\QB.xlsx"
...
'2020-2021
Selection.Replace What:="1 Year/2020-2021", Replacement:="'002020", LookAt _
        :=xlPart, SearchOrder:=xlByRows, MatchCase:=False, SearchFormat:=False, _
        ReplaceFormat:=False
Selection.Replace What:="1st2020-21", Replacement:="'012020", LookAt _
        :=xlPart, SearchOrder:=xlByRows, MatchCase:=False, SearchFormat:=False, _
        ReplaceFormat:=False
Selection.Replace What:="2nd2020-21", Replacement:="'022020", LookAt _
        :=xlPart, SearchOrder:=xlByRows, MatchCase:=False, SearchFormat:=False, _
        ReplaceFormat:=False
...
'2019-2020
Selection.Replace What:="1 Year/2019-2020", Replacement:="'002019", LookAt _
        :=xlPart, SearchOrder:=xlByRows, MatchCase:=False, SearchFormat:=False, _
        ReplaceFormat:=False
Selection.Replace What:="1st2019-20", Replacement:="'012019", LookAt _
        :=xlPart, SearchOrder:=xlByRows, MatchCase:=False, SearchFormat:=False, _
        ReplaceFormat:=False
Selection.Replace What:="2nd2019-20", Replacement:="'022019", LookAt _
        :=xlPart, SearchOrder:=xlByRows, MatchCase:=False, SearchFormat:=False, _
        ReplaceFormat:=False
      
Selection.Replace What:="1 Year/2018-2019", Replacement:="'002018", LookAt _
        :=xlPart, SearchOrder:=xlByRows, MatchCase:=False, SearchFormat:=False, _
        ReplaceFormat:=False
Selection.Replace What:="1st2018-19", Replacement:="'012018", LookAt _
        :=xlPart, SearchOrder:=xlByRows, MatchCase:=False, SearchFormat:=False, _
        ReplaceFormat:=False
Selection.Replace What:="2nd2018-19", Replacement:="'022018", LookAt _
        :=xlPart, SearchOrder:=xlByRows, MatchCase:=False, SearchFormat:=False, _
        ReplaceFormat:=False
...
Range("E2:E" & LastRow).Formula = "=CONCATENATE(""0994000174446"","" "",""01"","" "",RC[-3],"" "",RC[-2],"" "",RC[-1],""00"")"
...
Dim LastRow As Long
'FormulaStr = "=CONCATENATE(""" & Chr(124) & "|099400017444601"",""~013"",RC[-4],""~013"",RC[-3],""~013"",IF(RC[-2]=0,0,CONCATENATE(RC[-2],""00"")))"
Formula2 = "IF((RC[-2]-INT(RC[-2]))=0,CONCATENATE(RC[-2],""00""),SUBSTITUTE(RC[-2],""."",""""))"
'FormulaStr = "=CONCATENATE(""|099400017444601"",""~013"",RC[-4],""~013"",RC[-3],""~013"",IF(RC[-2]=0,0,CONCATENATE(RC[-2],""00"")))"
FormulaStr = "=CONCATENATE(""|099400017444601"",""~013"",RC[-4],""~013"",RC[-3],""~013""," & Formula2 & ")"
'MsgBox (FormulaStr)
...
FormulaStr = "=CONCATENATE(""|099400017444601"",CHAR(10),RC[-6],CHAR(10),RC[-5],CHAR(10)," & Formula2 & ")"
